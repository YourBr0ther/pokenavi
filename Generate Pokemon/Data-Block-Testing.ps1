Clear-Host
$pokemonPath = ".\Generate Pokemon\Sample PK3\CHARMELEON.ek3"
...
Write-Host "Decrypted Block 1 [H]: $db1Hex"
Write-Host "Decrypted Block 2 [H]: $db2Hex"
Write-Host "Decrypted Block 3 [H]: $db3Hex"
Write-Host "Decrypted Block 4 [H]: $db4Hex"
Write-Host "Decrypted Block 5 [H]: $db5Hex"
Write-Host "Decrypted Block 6 [H]: $db6Hex"
Write-Host "Decrypted Block 7 [H]: $db7Hex"
Write-Host "Decrypted Block 8 [H]: $db8Hex"
Write-Host "Decrypted Block 9 [H]: $db9Hex"
